    ...
    <div class="intro-y col-span-12 lg:col-span-12">
        <div class="intro-y box p-5">
            ...
            <div class="text-right mt-5">
                <button type="button" class="btn btn-outline-secondary w-24 mr-1">Cancel</button></a>
                <button wire:click="StoreProductData" type="submit" class="btn btn-primary w-24 mt-3">Save</button>
            </div>
        </form>
        </div>
    </div>
