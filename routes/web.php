...
use App\Http\Livewire\Form\ProductForm;
use App\Http\Controllers\AuthController;
use App\Http\Controllers\PageController;
use App\Http\Livewire\Form\EditProductForm;
...
Route::group(['prefix'],function(){
    ...
    Route::get('product/store', ProductForm::class);

    Route::get('/product/update/{modelID}', action:\App\Http\Livewire\Form\EditProductForm::class);
    });
});